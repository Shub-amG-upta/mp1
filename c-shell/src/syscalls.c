...
static const char *const names[]={
    ...
    [63]="uname", [64]="semget", [65]="semop", [66]="semctl", [67]="shmdt",
    [68]="msgget", [69]="msgsnd", [70]="msgrcv", [71]="msgctl", [72]="fcntl",
    ...
    [86]="link", [87]="unlink", [88]="symlink", [89]="readlink", [90]="chmod",
    ...
    [245]="mq_getsetattr", [246]="kexec_load", [247]="waitid", [248]="add_key",
    [249]="request_key", [250]="keyctl", [251]="ioprio_set", [252]="ioprio_get",
    [253]="inotify_init", [254]="inotify_add_watch", [255]="inotify_rm_watch",
    [256]="migrate_pages", [257]="openat", [258]="mkdirat", [259]="mknodat",
    [260]="fchownat", [261]="futimesat", [262]="newfstatat", [263]="unlinkat",
    ...
    [21]="epoll_ctl", [22]="epoll_pwait", [23]="dup", [24]="dup3", [25]="fcntl",
    [26]="inotify_init1", [27]="inotify_add_watch", [28]="inotify_rm_watch",
    ...
    [41]="pivot_root", [42]="nfsservctl", [43]="statfs", [44]="fstatfs",
    [45]="truncate", [46]="ftruncate", [47]="fallocate", [48]="faccessat",
    ...
    [69]="preadv", [70]="pwritev", [71]="sendfile", [72]="pselect6",
    [73]="ppoll", [74]="signalfd4", [75]="vmsplice", [76]="splice", [77]="tee",
    [78]="readlinkat", [79]="fstatat", [80]="fstat", [81]="sync", [82]="fsync",
    [83]="fdatasync", [84]="sync_file_range", [85]="timerfd_create",
    [86]="timerfd_settime", [87]="timerfd_gettime", [88]="utimensat",
    [89]="acct", [90]="capget", [91]="capset", [92]="personality", [93]="exit",
    [94]="exit_group", [95]="waitid", [96]="set_tid_address", [97]="unshare",
    [98]="futex", [99]="set_robust_list", [100]="get_robust_list",
    [101]="nanosleep", [102]="getitimer", [103]="setitimer", [104]="kexec_load",
    ...
    [218]="request_key", [219]="keyctl", [220]="clone", [221]="execve",
    [222]="mmap", [223]="fadvise64", [224]="swapon", [225]="swapoff",
    [226]="mprotect", [227]="msync", [228]="mlock", [229]="munlock",
    [230]="mlockall", [231]="munlockall", [232]="mincore", [233]="madvise",
    [234]="remap_file_pages", [235]="mbind", [236]="get_mempolicy",
    [237]="set_mempolicy", [238]="migrate_pages", [239]="move_pages",
    [240]="rt_tgsigqueueinfo", [241]="perf_event_open", [242]="accept4",
    [243]="recvmmsg", [244]="arch_specific_syscall", [260]="wait4",
    [261]="prlimit64", [262]="fanotify_init", [263]="fanotify_mark",
    ...
    [403]="clock_gettime64", [404]="clock_settime64", [405]="clock_adjtime64",
    [406]="clock_getres_time64", [407]="clock_nanosleep_time64",
    [408]="timer_gettime64", [409]="timer_settime64", [410]="timerfd_gettime64",
    [411]="timerfd_settime64", [412]="utimensat_time64",
    [413]="pselect6_time64", [414]="ppoll_time64", [416]="io_pgetevents_time64",
    [417]="recvmmsg_time64", [418]="mq_timedsend_time64",
    [419]="mq_timedreceive_time64", [420]="semtimedop_time64",
    [421]="rt_sigtimedwait_time64", [422]="futex_time64",
    [423]="sched_rr_get_interval_time64", [424]="pidfd_send_signal",
    [425]="io_uring_setup", [426]="io_uring_enter", [427]="io_uring_register",
    [428]="open_tree", [429]="move_mount", [430]="fsopen", [431]="fsconfig",
    [432]="fsmount", [433]="fspick", [434]="pidfd_open", [435]="clone3",
    [436]="close_range", [437]="openat2", [438]="pidfd_getfd",
...
const char *syscall_name(long number){
    if(number<0 || (size_t)number>=sizeof(names)/sizeof(names[0])) return NULL;
    return names[number];
}